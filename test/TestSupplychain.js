...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function manufactureItem() that allows a Manufacturer to manufacture cellphone", async() => {
        ...
        let result = await supplyChain.manufactureItem(upc, originManufacturerID, originManufacturerName, originManufacturerInformation, originManufacturerLatitude, originManufacturerLongitude, productNotes);
    ...
    // 4th Test
    it("Testing smart contract function sellItem() that allows a Manufacturer to sell coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
